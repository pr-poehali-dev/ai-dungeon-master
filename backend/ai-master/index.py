...
## ФОРМАТ ЗАПРОСА БРОСКА (обязательный)
[Требуется проверка: Название навыка (Характеристика) СЛ X]
Обстоятельства: Краткое описание ситуации.
Модификаторы: Есть ли преимущество / помеха / бонусы?
→ Брось к20 во вкладке «Кости», прибавь модификатор навыка и напиши результат в чат.
